...
extension Order: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeRepeatedMessageField(value: &self.cartItems)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.cartItems.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.cartItems, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
